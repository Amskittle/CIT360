...
/*
 * This class follows the singleton pattern. One object per class.
 */
...

{
	...
	static{
		...
		config.setProperty("hibernate.connection.url", "jdbc:mysql://localhost/quiz");

		//change the next two lines of code to match your MySQL user name and password.

		config.setProperty("hibernate.connection.username", "root");

		config.setProperty("hibernate.connection.password", "Mk@yN0r2011!");
